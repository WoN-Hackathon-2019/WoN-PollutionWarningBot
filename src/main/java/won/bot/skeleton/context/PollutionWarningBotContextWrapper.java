...
public class PollutionWarningBotContextWrapper extends ServiceAtomEnabledBotContextWrapper {
    private final String connectedSocketsMap;

    public PollutionWarningBotContextWrapper(BotContext botContext, String botName) {
